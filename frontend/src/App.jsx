...
const audiences = [
  { number: '01', title: 'À chaque âge', text: 'Enfant, adolescent, adulte ou senior : une prise en charge adaptée à votre quotidien et à vos objectifs.' },
  { number: '02', title: 'Sport & mouvement', text: 'Pour accompagner la reprise, préparer une échéance ou retrouver de la confiance dans vos mouvements.' },
  { number: '03', title: 'Grossesse & post-partum', text: 'Un accompagnement pensé pour les changements du corps, avant et après la naissance.' },
]
  ...
  return (
    <div className="site-shell">
      <header className={`site-header ${scrolled ? 'is-scrolled' : ''}`}>
        <a className="brand" href="#accueil" aria-label="Retour à l’accueil"><LeafMark /><span><strong>OSTÉO</strong><small>PLERGUER</small></span></a>
      ...
      <main>
        <section className="hero" id="accueil" aria-labelledby="hero-title">
          ...
          <div className="hero-art" aria-label="Formes organiques évoquant le mouvement et l’équilibre">
            <div className="sun-disc" /><div className="arch arch-one" /><div className="arch arch-two" /><div className="arch arch-three" />
        ...
        <section className="consultation-section" id="consultation" aria-labelledby="consultation-title">
          <div className="consultation-art" aria-hidden="true"><span className="round-shape" /><span className="line-shape" /><span className="dotted-shape" /></div>
      ...
      <footer><a className="brand" href="#accueil"><LeafMark /><span><strong>OSTÉO</strong><small>PLERGUER</small></span></a><p>Cabinet d’ostéopathie<br />Maxime Lebreton</p><div><a href="https://www.doctolib.fr/osteopathe/plerguer/maxime-lebreton" target="_blank" rel="noreferrer">Rendez-vous en ligne</a><span>© {new Date().getFullYear()}</span></div></footer>
    </div>
  )
}
